...
def parse_args():
    ...
    parser.add_argument('--model_name', dest='model_name', default="frozen_inference_graph.pb", help="Please set --model_name", type=str)
...
if __name__ == '__main__':
    ...
    PATH_TO_CKPT = os.path.join(args.model, TRAIN_MODEL, args.model_name)
